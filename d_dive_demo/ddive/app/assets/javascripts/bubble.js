...
function bubble(){
	...
	q.innerHTML = '<style>html,body{overflow-x:hidden;}.bubble{position:absolute;background:rgba(255,255,255,0.1);border:thin solid rgba(255,255,225,0.3);border-radius:16px;box-shadow: 0 0 1px 1px rgba(255,255,225,0.2);}'+
	'.bubble::after{content:"";display:block;height:3px;width:3px;border-radius:4px;background:rgba(255,255,255,0.2);}</style>';
	q.id = 'bubbleparticle';
	b.appendChild(q);
	...
	for(var i=0;i<50;i++){//【1】泡の量を指定
		...
		s[i] = Math.random()*8+0.5;//【2】泡の上昇速度
